...
CREATE TABLE club (
	...
	,CONSTRAINT club_capitaine_FK FOREIGN KEY (numCapitaine) REFERENCES participant(num)
	,CONSTRAINT club_equipier_FK FOREIGN KEY (numEquipier) REFERENCES participant(num)
)WITHOUT OIDS;
